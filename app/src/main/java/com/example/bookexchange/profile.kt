...
//        header navigation view
        ...
        user_head.text = intent.getStringExtra("user")
        ...
        nav!!.setNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                ...
                R.id.menu_nav_history -> {
                    Toast.makeText(applicationContext, "History Panel is Open", Toast.LENGTH_LONG)
                        .show()
                    drawerLayout!!.closeDrawer(GravityCompat.START)
                }
                R.id.menu_nav_collection -> {
                    Toast.makeText(
                        applicationContext,
